"""
Classe de base abstraite pour les générateurs turn
"""
from abc import ABC, abstractmethod

class BaseTurnGenerator(ABC):
    """
    Classe abstraite fournissant des fonctionnalités communes à tous les générateurs turn
    """
