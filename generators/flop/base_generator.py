"""
Classe de base abstraite pour les générateurs flop
"""
from abc import ABC, abstractmethod

class BaseFlopGenerator(ABC):
    """
    Classe abstraite fournissant des fonctionnalités communes à tous les générateurs flop
    """
